...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("-c foo bar baz /tmp", False, ["foo", "bar", "baz"], ["/tmp"]),
        ("-cv foo bar baz /tmp", False, ["foo", "bar", "baz"], ["/tmp"]),
        ("-c -v foo bar baz /tmp", False, ["foo", "bar", "baz"], ["/tmp"]),
        ("-cbCM foo bar baz /tmp", False, ["foo", "bar", "baz"], ["/tmp"]),
        ("-g wheel -o root -m 0755 foo bar baz /tmp", False, ["foo", "bar", "baz"], ["/tmp"]),
        # Broken inputs.
        ("", False, [], []),
        ("foo", False, [], []),
    ],
